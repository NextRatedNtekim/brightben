...
import loyal from "../assets/loyal.jpeg"
...
const projects = [
  {
    ...
    bullets: [
      <>
        Collaborated with the Loyal team to support community growth and ecosystem visibility through structured engagement, educational content, and audience interaction strategies.
      </>,
      <>
        Delivered weekly external KPIs including:
        <ul>
            <li> A post focused on engagement and brand visibility</li>
            <li>1 infographic simplifying ecosystem updates and concepts</li>
            <li>1 product demo content piece showcasing platform features and usability</li>
            <li>1 community contact initiative to strengthen partnerships and outreach</li>
        </ul>
      </>,
      <>
        Contributed to internal growth initiatives by submitting community-focused proposals aimed at improving engagement strategies, user retention, and overall community experience.
      </>,
      <>
        Supported community management and user assistance efforts by maintaining active discussions, responding to inquiries, and helping create a more interactive ecosystem environment.
      </>,
      <>
        Produced audience-driven content tailored for both existing Web3 users and newcomers, improving accessibility, participation, and community interaction.
      </>,
